...
from src.examples.d_repetition.repetition import get_sum__for, sum_of_squares, sum_of_squares_for, test_config
...
class Test_Config(unittest.TestCase):
    ...
    def test_sum_for(self):
        self.assertEqual(get_sum__for(3), 6)
        self.assertEqual(get_sum__for(4), 10)
